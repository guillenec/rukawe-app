...
const ErrorSection = () => {
  return (
    <>
              ...
              <div className="screen_out">
                <div className="screen_out1">
                  <div className="screen">
                    <span className="notfound_text">NO FUNCIONA</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className='containVolver'>
        <Link to="/" className='font-parrafo font-bold text-2xl text-red-500 rounded-lg flex justify-center items-center border-2 border-red-500 px-3 py-1 gap-1'>
